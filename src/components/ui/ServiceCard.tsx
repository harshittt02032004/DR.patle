  ...
  return (
    ...
    >
      <Link
        ...
        className="group relative block h-full overflow-hidden rounded-2xl border border-line bg-white p-7 shadow-card transition-all duration-300 hover:-translate-y-1.5 hover:border-teal-lighter hover:shadow-lift"
      >
        ...
        <span className="mt-4 inline-block text-sm font-semibold text-teal transition-transform duration-300 group-hover:translate-x-1">
          Learn more →
        </span>
      </Link>
    </motion.div>
